...
|-----|--------|---------|---------|
| [GitHub Copilot CLI](#github-copilot-cli) | GitHub | v1.0.11 | `npm install -g @github/copilot` |
| [OpenAI Codex CLI](#openai-codex-cli) | OpenAI | v0.116.0 | `npm install -g @openai/codex` |
| [Claude Code CLI](#claude-code-cli) | Anthropic | v2.1.84 | `npm install -g @anthropic-ai/claude-code` |
| [Gemini CLI](#gemini-cli) | Google | v0.35.1 | `npm install -g @google/gemini-cli` |
...
| `/plugin [marketplace\|install\|uninstall\|update\|list]` | Manage plugins and marketplaces |
| `/quit` | Exit the CLI |
...
| `/share [file\|gist] [PATH]` | Share the session to a file or GitHub gist |
| `/skills [list\|info\|add\|remove\|reload]` | Manage skills for enhanced capabilities |
...
| `/theme` | Open the theme picker and save selection |
